package php.codeGolf.training.ui
...
class UISettings {
  ...
  companion object {
    val instance: php.codeGolf.training.ui.UISettings
      get() = ServiceManager.getService(php.codeGolf.training.ui.UISettings::class.java)
    ...
    fun rigidGap(settingsValue: KProperty<Int>, isVertical: Boolean = true): Box.Filler {
      val value = settingsValue.call(php.codeGolf.training.ui.UISettings.instance)
