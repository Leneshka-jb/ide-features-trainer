...
open class GotoActionLesson(module: Module, lang: String, private val sample: LessonSample, name: String) :
        KLesson(name, module, lang) {

    constructor(module: Module, lang: String, sample: LessonSample) : this(module, lang, sample, "Actions")
