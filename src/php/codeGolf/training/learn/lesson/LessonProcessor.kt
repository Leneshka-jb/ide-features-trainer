...
import php.codeGolf.training.commands.Command
import php.codeGolf.training.commands.CommandFactory
import php.codeGolf.training.commands.ExecutionList
...
object LessonProcessor {
  ...
  var currentExecutionList: php.codeGolf.training.commands.ExecutionList? = null
    private set
